...
|---|---|---|
| 1 Zugang | Hostpoint-Konto auf die Betreiberin, zweite Person mit Zugriff (Vertretung), Zwei-Faktor-Anmeldung im Control Panel | Konto vorhanden (Emotionframe GmbH); Vertretung und Zwei-Faktor bewusst zurückgestellt (Entscheid 14.09.2026), vor dem öffentlichen Pilot nachzuholen |
...
| 9 Fehlerkontakt | Adresse einrichten, in Impressum und Datenschutz eintragen, Sofortweg nach `redaktionsdurchlauf.md` 2 bekannt | 14.09.2026: kontakt@povratnik.com eingerichtet und in Impressum und Datenschutz eingetragen |
