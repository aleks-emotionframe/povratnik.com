...
export const RUBRICS: Rubric[] = [
  {
    ...
    intro: "Vor dem Status ist nichts entscheidbar: Er bestimmt den Aufenthaltsweg, den Zugang zur Arbeit, zur Schule und zu Förderungen.",
  ...
  },
  {
    ...
    intro: "Steuerliche Ansässigkeit, Doppelbesteuerung und die Anrechnung ausländischer Renten sind die Themen, bei denen eine kroatische Fachperson beizuziehen ist.",
  ...
  },
  {
    ...
    intro: "Staat, Gespanschaften und Gemeinden fördern die Rückkehr, aber zersplittert. Jede Leistung trägt bei uns Zustand, Quelle und Prüfdatum.",
